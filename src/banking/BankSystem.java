...
public class BankSystem extends JFrame implements ActionListener, ItemListener {
	...
	public BankSystem() {
		...
		setUpMenuItemsforFileMenu();
		setUpMenuItemsforEditMenu();
		setUpMenuItemsforViewMenu();
		setupMenuItemsforOptionMenu();
		setupMenuItemsforWindowMenu();
		setupMenuItemsforHelpMenu();
	...
	private void setupMenuItemsforHelpMenu() {
	...
	private void setupMenuItemsforWindowMenu() {
	...
	private void setupMenuItemsforOptionMenu() {
	...
	private void setUpMenuItemsforViewMenu() {
	...
	private void setUpMenuItemsforEditMenu() {
	...
	private void setUpMenuItemsforFileMenu() {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (obj == addNew || obj == open || obj == btnNew) {
			...
			if (b == false) {
				FindAccount fndAcc = new FindAccount(db);
				desktop.add(fndAcc);
				fndAcc.show();
			}
			...
			if (b == false) {
				FindName fndNm = new FindName(db);
				desktop.add(fndNm);
				fndNm.show();
			}
	...
	void findRec(String rec) {
		int fi=db.findByNo(rec);
		if(fi>-1) printRecord(makeRecordPrint(fi));
		else {
